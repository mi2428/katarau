            ...
            <v-card-title primary-title>
              <div>
                ...
                <span class="card_content">
                  ...
                  近くにヘルプを求める方が沢山います．<br>
                  しかし周囲の人たちが,そのヘルプに気づきにくいのが現状です<br>
          ...
          <v-card color="lime">
            <v-card-title primary-title>
              <div>
                ...
                <span class="card_content">
                  学生が身内以外の高齢者と交流できる機会は限られています.<br>
                  お手伝いを通じて、人生経験が豊富な年配の方と交流することにより,自身の見識や行動などが広がる可能性を提案します．<br>
                  また、授業の空きコマなどの隙間時間に短時間で可能なバイトとして
          ...
          <v-card color="lime">
            <v-card-title primary-title>
              <div>
                ...
                <span class="card_content">
                  会員登録をした学生の皆さんには,高齢者のヘルプに応じて連絡がいきます.
                </span>
              </div>
            </v-card-title>
          </v-card>
